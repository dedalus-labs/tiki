Microbenchmarks comparing Tiki to PyTorch
========================================

Implement the same microbenchmarks in Tiki and PyTorch to compare and make a
list of the biggest possible performance improvements and/or regressions.

Run with `python bench_tiki.py sum_axis --size 8x1024x128 --axis 2 --cpu` for
