...
void init_tiki_func(nb::module_&);
...
NB_MODULE(core, m) {
  m.doc() = "tiki: A framework for machine learning on Apple silicon.";

  auto reprlib_fix = nb::module_::import_("tiki._reprlib_fix");
  nb::set_leak_warnings(false);

  auto array_namespace_info = nb::module_::import_("tiki.__array_api_info");
