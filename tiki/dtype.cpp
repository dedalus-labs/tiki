...
template class TIKI_API TypeToDtype<bool>;
template class TIKI_API TypeToDtype<uint8_t>;
template class TIKI_API TypeToDtype<uint16_t>;
template class TIKI_API TypeToDtype<uint32_t>;
template class TIKI_API TypeToDtype<uint64_t>;
template class TIKI_API TypeToDtype<int8_t>;
template class TIKI_API TypeToDtype<int16_t>;
template class TIKI_API TypeToDtype<int32_t>;
template class TIKI_API TypeToDtype<int64_t>;
template class TIKI_API TypeToDtype<float16_t>;
template class TIKI_API TypeToDtype<float>;
template class TIKI_API TypeToDtype<double>;
template class TIKI_API TypeToDtype<bfloat16_t>;
template class TIKI_API TypeToDtype<complex64_t>;
