...
TIKI_API void async_eval(std::vector<array> outputs);
...
TIKI_API void eval(std::vector<array> outputs);
 ...
 **/
TIKI_API std::pair<std::vector<array>, std::vector<array>> vjp(
 ...
 */
TIKI_API std::pair<array, array> vjp(
 ...
 **/
TIKI_API std::pair<std::vector<array>, std::vector<array>> jvp(
    const std::function<std::vector<array>(const std::vector<array>&)>& fun,
    const std::vector<array>& primals,
 ...
 */
TIKI_API std::pair<array, array> jvp(
    const std::function<array(const array&)>& fun,
    const array& primal,
    const array& tangent);
 ...
 **/
TIKI_API ValueAndGradFn value_and_grad(
    const std::function<std::vector<array>(const std::vector<array>&)>& fun,
 ...
 */
TIKI_API std::function<array(const array&)> vmap(
    const std::function<array(const array&)>& fun,
    int in_axis = 0,
    int out_axis = 0);
 ...
 */
TIKI_API std::function<array(const array&, const array&)> vmap(
 ...
 * function.
 */
TIKI_API std::function<std::vector<array>(const std::vector<array>&)> vmap(
    const std::function<std::vector<array>(const std::vector<array>&)>& fun,
