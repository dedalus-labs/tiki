...
TIKI_API array fftfreq(int n, double d = 1.0, StreamOrDevice s = {});

/** Compute the discrete Fourier Transform sample frequencies for
 * `rfft`/`irfft`. */
TIKI_API array rfftfreq(int n, double d = 1.0, StreamOrDevice s = {});

/** Shift the zero-frequency component to the center of the spectrum. */
TIKI_API array fftshift(const array& a, StreamOrDevice s = {});
...
TIKI_API array ifftshift(const array& a, StreamOrDevice s = {});
