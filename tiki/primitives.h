...
class TIKI_API UnaryPrimitive : public Primitive {
  /**
...
class TIKI_API Add : public UnaryPrimitive {
 public:
...
class TIKI_API ArgReduce : public UnaryPrimitive {
 public:
  enum ReduceType {
    ArgMin,
    ArgMax,
...
class TIKI_API Compiled : public Primitive {
 public:
  /*
...
class TIKI_API Exp : public UnaryPrimitive {
 public:
...
class TIKI_API Reduce : public UnaryPrimitive {
 public:
