 ...
 * */
TIKI_API size_t get_active_memory();
 ...
 * */
TIKI_API size_t get_array_buffer_size(const std::vector<array>& arrays);
 ...
 * */
TIKI_API size_t get_peak_memory();

/* Reset the peak memory to zero.
 * */
TIKI_API void reset_peak_memory();
 ...
 * */
TIKI_API size_t get_cache_memory();
 ...
 * */
TIKI_API size_t set_memory_limit(size_t limit);

/* Get the current memory limit. */
TIKI_API size_t get_memory_limit();
 ...
 * */
TIKI_API size_t set_cache_limit(size_t limit);

/* Clear the memory cache. */
TIKI_API void clear_cache();
 ...
 * */
TIKI_API size_t set_wired_limit(size_t limit);
