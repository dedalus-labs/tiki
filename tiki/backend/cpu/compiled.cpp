...
#include "tiki/backend/cpu/jit_compiler.h"
...
void* compile(
  ...
  auto output_dir =
      std::filesystem::temp_directory_path() / "tiki" / version() / "cpu";
...
void Compiled::eval_cpu(
  ...
  auto fn_ptr = compile(kernel_name, [&, contiguous = contiguous]() {
    ...
    kernel << "#ifndef NAN\n"
              ...
              "#endif\n";
    kernel << "using namespace tiki::core;" << std::endl;
    kernel << "using namespace tiki::core::detail;" << std::endl;
