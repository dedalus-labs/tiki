...
#define TIKI_DEFINE_BINARY_OP(NAME, HALF_OP)                        \
  template <typename T>                                            \
...
TIKI_DEFINE_BINARY_OP(max, __hmax)
TIKI_DEFINE_BINARY_OP(min, __hmin)

#undef TIKI_DEFINE_BINARY_OP
...
#define TIKI_DEFINE_HALF_OP(HALF, HALF2FLOAT, FLOAT2HALF, OP)          \
  template <                                                          \
      typename T,                                                     \
...
#define TIKI_DEFINE_HALF_CMP(HALF, HALF2FLOAT, OP)                       \
  template <                                                            \
      typename T,                                                       \
...
TIKI_DEFINE_HALF_OP(__half, __half2float, __float2half, +)
TIKI_DEFINE_HALF_OP(__half, __half2float, __float2half, -)
TIKI_DEFINE_HALF_OP(__half, __half2float, __float2half, *)
TIKI_DEFINE_HALF_OP(__half, __half2float, __float2half, /)
TIKI_DEFINE_HALF_OP(__nv_bfloat16, __bfloat162float, __float2bfloat16, +)
TIKI_DEFINE_HALF_OP(__nv_bfloat16, __bfloat162float, __float2bfloat16, -)
TIKI_DEFINE_HALF_OP(__nv_bfloat16, __bfloat162float, __float2bfloat16, *)
TIKI_DEFINE_HALF_OP(__nv_bfloat16, __bfloat162float, __float2bfloat16, /)
TIKI_DEFINE_HALF_CMP(__half, __half2float, <)
TIKI_DEFINE_HALF_CMP(__half, __half2float, >)
TIKI_DEFINE_HALF_CMP(__half, __half2float, <=)
TIKI_DEFINE_HALF_CMP(__half, __half2float, >=)
TIKI_DEFINE_HALF_CMP(__half, __half2float, ==)
TIKI_DEFINE_HALF_CMP(__half, __half2float, !=)
TIKI_DEFINE_HALF_CMP(__nv_bfloat16, __bfloat162float, <)
TIKI_DEFINE_HALF_CMP(__nv_bfloat16, __bfloat162float, >)
TIKI_DEFINE_HALF_CMP(__nv_bfloat16, __bfloat162float, <=)
TIKI_DEFINE_HALF_CMP(__nv_bfloat16, __bfloat162float, >=)
TIKI_DEFINE_HALF_CMP(__nv_bfloat16, __bfloat162float, ==)
...
#undef TIKI_DEFINE_HALF_OP
#undef TIKI_DEFINE_HALF_CMP
