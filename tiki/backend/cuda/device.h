...
#include "tiki/backend/cuda/lru_cache.h"
#include "tiki/backend/cuda/utils.h"
...
TIKI_API Device& device(int cuda_device);
TIKI_API Device& device(tiki::core::Device d);
TIKI_API CommandEncoder& get_command_encoder(Stream s);
