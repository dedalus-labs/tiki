...
#include "tiki/backend/common/quantized.h"
#include "tiki/backend/cuda/device.h"
#include "tiki/backend/cuda/kernel_utils.cuh"
#include "tiki/backend/cuda/quantized/fp_quantize.cuh"
#include "tiki/backend/cuda/quantized/quantized.h"
#include "tiki/backend/cuda/vector_types.cuh"
...
void fp_quantize_dequantize(
  ...
  dispatch_float_types(w.dtype(), "fp_quantize_dequantize", [&](auto type_tag) {
    using T = cuda_type_t<TIKI_GET_TYPE(type_tag)>;
