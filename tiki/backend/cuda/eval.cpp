...
#include "tiki/backend/gpu/eval.h"
#include "tiki/backend/cuda/allocator.h"
#include "tiki/backend/cuda/cublas_utils.h"
#include "tiki/backend/cuda/cudnn_utils.h"
#include "tiki/backend/cuda/cusolver_utils.h"
#include "tiki/backend/cuda/event.h"
...
void init() {
  ...
  tiki::core::cu::CudaEvent::init_pool();
...
void eval(array& arr) {
  ...
  // Ensure CUDA context is active on this thread. Required when Tiki is called
