...
struct Conv2DInputBlockLoaderLargeFilter {
  ...
  const constant TIKIConvParams<2>* params;
  ...
  METAL_FUNC Conv2DInputBlockLoaderLargeFilter(
      ...
      threadgroup T* dst_,
      const int2 offsets,
      const constant TIKIConvParams<2>* params_,
...
struct Conv3DInputBlockLoaderLargeFilter {
  ...
  const constant TIKIConvParams<3>* params;
  ...
  METAL_FUNC Conv3DInputBlockLoaderLargeFilter(
      ...
      threadgroup T* dst_,
      const int2 offsets,
      const constant TIKIConvParams<3>* params_,
