...
#include "tiki/backend/metal/kernels/bf16.h"
#include "tiki/backend/metal/kernels/bf16_math.h"
#include "tiki/backend/metal/kernels/complex.h"
...
// match get_work_per_thread in tiki/backend/metal/utils.h
template <typename U>
