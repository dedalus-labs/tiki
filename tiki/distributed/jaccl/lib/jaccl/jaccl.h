 ...
 *   - JACCL_RANK / TIKI_RANK: The rank of this process
 *   - JACCL_IBV_DEVICES / TIKI_IBV_DEVICES: Path to the device connectivity
 *     JSON file
 *   - JACCL_COORDINATOR / TIKI_JACCL_COORDINATOR: IP:port of the coordinator
 *   - JACCL_RING / TIKI_JACCL_RING: If set, prefer ring topology
 *
 * Args:
