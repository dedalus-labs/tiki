...
struct TIKI_API FunctionExporter {
 ...
 private:
  friend TIKI_API FunctionExporter exporter(
      const std::string&,
...
struct TIKI_API ImportedFunction {
 ...
 private:
  ...
  friend TIKI_API ImportedFunction import_function(const std::string&);
  ImportedFunction();
