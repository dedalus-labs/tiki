...
By default, Tiki may run ``float32`` matrix-multiplication family
...
:envvar:`TIKI_ENABLE_TF32` to ``0`` when launching the process:

.. code-block:: shell

  TIKI_ENABLE_TF32=0 python my_script.py
